 ...
 * 
 */
@HandlerChain(file = "com/serviceexample/handler-chain.xml")

@WebServiceClient(name = "EmployeeService", targetNamespace = "http://serviceExample.com", wsdlLocation = "http://localhost:8091/services?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESERVICE_QNAME = new QName("http://serviceExample.com", "EmployeeService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8091/services?wsdl");
    ...
    public EmployeeSEI getEmployeePort() {
        return super.getPort(new QName("http://serviceExample.com", "EmployeePort"), EmployeeSEI.class);
    }
     ...
     */
    @WebEndpoint(name = "EmployeePort")
    public EmployeeSEI getEmployeePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://serviceExample.com", "EmployeePort"), EmployeeSEI.class, features);
    }
